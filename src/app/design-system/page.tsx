...
export default function DesignSystemPage() {
  ...
  return (
    <main className="min-h-screen uppercase flex flex-col relative overflow-x-hidden w-full max-w-5xl mx-auto border-x border-terminal-tertiary/20 pb-24 px-4 md:px-0">
      
      <header className="flex justify-between items-center p-6 border-b border-terminal-tertiary/30 bg-terminal-neutral/50 backdrop-blur-sm z-10 sticky top-0">
        <h1 className="text-2xl tracking-widest font-bold drop-shadow-[0_0_8px_rgba(0,255,0,0.8)]">
          {'>'} NEON_TERMINAL_DS <span className="animate-pulse">_</span>
        </h1>
      ...
      <div className="p-6 space-y-12">
        ...
        <TuiSection title="Colors & Surface Logic">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="p-6 bg-terminal-primary text-terminal-black font-bold border border-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.4)]">
              <div className="text-sm">Primary</div>
              <div className="text-[10px] opacity-70 font-mono mt-2">bg-terminal-primary</div>
            </div>
            <div className="p-6 bg-terminal-neutral text-terminal-primary border border-terminal-tertiary/40">
              <div className="text-sm">Neutral</div>
              <div className="text-[10px] opacity-70 font-mono mt-2">bg-terminal-neutral</div>
            </div>
            <div className="p-6 bg-terminal-secondary text-terminal-primary border border-terminal-tertiary/40">
              <div className="text-sm">Secondary</div>
              <div className="text-[10px] opacity-70 font-mono mt-2">bg-terminal-secondary</div>
            </div>
            <div className="p-6 bg-terminal-tertiary text-white border border-white/20">
              <div className="text-sm">Tertiary</div>
              <div className="text-[10px] opacity-70 font-mono mt-2">bg-terminal-tertiary</div>
            </div>
            <div className="p-6 bg-terminal-black border border-terminal-tertiary text-terminal-primary">
              <div className="text-sm">Background</div>
              <div className="text-[10px] opacity-70 font-mono mt-2">bg-terminal-black</div>
            </div>
          </div>
          <div className="mt-4 p-4 border border-terminal-tertiary/30 border-dashed text-xs tracking-widest text-muted-foreground normal-case font-mono">
        ...
        <TuiSection title="Typography Highlights">
          <div className="space-y-8">
            <div className="border-l-2 border-terminal-primary pl-4">
              ...
              <h1 className="text-4xl tracking-tighter font-bold drop-shadow-[0_0_8px_rgba(0,255,0,0.6)]">CONSOLE HEADER</h1>
            </div>
            <div className="border-l-2 border-terminal-primary pl-4">
        ...
        <TuiSection title="Component Library">
          <div className="space-y-16">
            ...
            {/* Data Boxes */}
            <div>
              <h3 className="text-[11px] font-bold tracking-widest uppercase text-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.8)] mb-6">{'>'} Data Boxes</h3>
            ...
            {/* Forms */}
            <div>
              <h3 className="text-[11px] font-bold tracking-widest uppercase text-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.8)] mb-6">{'>'} Form Groups & Inputs</h3>
                ...
                <TuiFormGroup>
                  <div className="flex flex-col gap-3">
                    ...
                    <input 
                      ...
                      defaultValue="1.0" 
                      readOnly
                      className="w-full sm:w-64 text-center text-xl font-bold bg-terminal-neutral text-terminal-primary px-2 py-3 rounded-none shadow-none border border-terminal-tertiary focus:border-terminal-primary focus:outline-none focus:ring-1 focus:ring-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.5)]"
                    />
                  </div>
                </TuiFormGroup>
            ...
            {/* Banners */}
            <div>
              <h3 className="text-[11px] font-bold tracking-widest uppercase text-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.8)] mb-6">{'>'} Information Banners</h3>
            ...
            {/* Loaders */}
            <div>
              <h3 className="text-[11px] font-bold tracking-widest uppercase text-terminal-primary drop-shadow-[0_0_5px_rgba(0,255,0,0.8)] mb-6">{'>'} Skeleton & Loaders</h3>
              <div className="bg-terminal-secondary/40 border border-terminal-tertiary/20">
