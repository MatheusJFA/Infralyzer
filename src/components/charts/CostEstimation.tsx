...
export function CostEstimation({ projections, onLoadingChange, onPricingLoaded, hideLoader = false}: CostEstimationProps) {
 ...
 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-paper-outline/30 border-dashed pb-4">
 <h3 className="text-sm font-bold tracking-widest uppercase text-paper-primary ">ESTIMATED MONTHLY TRAJECTORY COSTS</h3>
 {cacheTime && !isLoading && (
 <span className="text-[10px] font-bold tracking-widest uppercase px-2 py-1 border border-paper-primary text-paper-primary bg-paper-primary/5">
 PRICING API CACHED AT: {cacheTime}
 </span>
 )}
 </div>

 {isLoading && !hideLoader ? (
 <div className="flex justify-center items-center text-xs text-paper-primary font-bold p-6 border border-paper-primary/30 border-dashed bg-card tracking-widest uppercase">
 <svg className="animate-spin -ml-1 mr-3 h-4 w-4 text-paper-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
 ...
 <>
 <div className="mt-0 mb-6 border border-paper-primary border-dashed p-4 text-[10px] font-bold tracking-widest text-paper-primary uppercase bg-card/30 ">
