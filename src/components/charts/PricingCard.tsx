...
const themeConfigs = {
  orange: {
    ...
    text: "text-slate-500",
    textMuted: "text-slate-500/70",
    textDim: "text-slate-500/20",
    textSoft: "text-slate-500/80",
    textStrong: "text-slate-500/90",
    borderMuted: "border-slate-500/50",
  },
  blue: {
  ...
  green: {
    ...
    textDim: "text-slate-600/20",
    textSoft: "text-slate-600/80",
    textStrong: "text-slate-600/90",
    borderMuted: "border-slate-600/50",
  },
  red: {
    border: "border-paper-outline/80",
    text: "text-paper-primary/60",
    textMuted: "text-paper-primary/40",
    textDim: "text-paper-primary/10",
    textSoft: "text-paper-primary/50",
    textStrong: "text-paper-primary/70",
    borderMuted: "border-paper-outline/50",
  },
};
